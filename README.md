...
### Issue
There was a trouble running a client to connect to the server in the following settings:
...
* Run a PowerShell script to forward the port from Windows to WSL (following https://sungyong.medium.com/wsl2-port-forwarding-2f984a26c1fd).<br/>
