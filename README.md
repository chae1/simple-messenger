...
* Run a PowerShell script to forward the port from Windows to WSL's local ip address (following https://sungyong.medium.com/wsl2-port-forwarding-2f984a26c1fd).<br/>
